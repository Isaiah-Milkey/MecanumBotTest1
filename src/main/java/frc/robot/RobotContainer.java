...
public class RobotContainer {
  ...
  // public static VictorSP intakeMotor;
    ...
    public static Command m_RunIntake;
    public static Command m_ExtendRetractIntake;
    public static Command m_ParallelIntakeCommand;
// The robot's subsystems
    public static Intake m_intake;
    public static Intake m_intake2;
...
// Joysticks
  ...
  */
  private RobotContainer() {
    ...
    m_intake = new Intake();
    // m_ExtendRetractIntake = new ExtendRetractIntake(m_intake);
    // m_RunIntake = new RunIntake(m_intake);
    // m_ParallelIntakeCommand = new ParallelIntakeCommand(m_intake);
...
// Create some buttons
 JoystickButton intakeButton = new JoystickButton(joystickDriver, 2);        
// intakeButton.whileHeld(new ExtendRetractIntake( m_intake ) ,true);
    ...
    //Problem 2- cant run 2 commands that use same subsytem
    ...
    //  intakeButton.whileHeld(m_ParallelIntakeCommand);

      // intakeButton.whenHeld( new ParallelIntakeCommand(m_intake));
